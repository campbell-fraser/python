...
print("BEETLE RULES")
print("The aim of the game in Beetle is to be the first player to draw a complete beetle. The body parts are each given a number.")
print("\n6 = Body (you need the body before you can add anything else)")
print("5 = Head (you need the head before you can add the antenna or eyes)")
print("4 = Wings (you need 2 of these)")
print("3 = Legs (you need 6 of these)")
print("2 = Antenna (you need 2 of these)")
print("1 = Eye (you need 2 of these)")
print("\nIf you collect all of these parts, you win!")
print("It's recommended you play with a piece of paper next to you, as it's pretty easy to lose track.")
print("Have fun and good luck!\n")

while playagain == True:
    play = True
	#defines variable "player" so that the program knows who's go it is later
    player = "player 1"
    ...
    while play == True:
        if player == "player 1":
            ...
            if play == True:
                time.sleep(0.5)
                print("")
				#makes the apostrophe appear in the right place
            ...
            if roll == 6 and No_6 == True:
				...
				#makes it so that message doesn't appear if 6 is rolled again
                No_6 = False
            if roll == 5 and No_5 == True and No_6 == False:
                print("You got the head! Now you can begin to add the eyes (1) and antenna (2).")
                beetle_count = beetle_count + 1
				#again, makes it so that the message for getting 5 doesn't appear again
                No_5 = False
